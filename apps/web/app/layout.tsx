      ...
      <body className="min-h-screen flex flex-col">
        ...
        <header className="border-b border-amber-200 bg-amber-50">
          <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3">
            ...
            <nav className="flex items-center gap-4 text-sm">
              ...
              <Link href="/coverage" className="text-stone-700 hover:text-stone-900">Coverage</Link>
        ...
        <footer className="border-t border-stone-200 bg-white">
          <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-6 text-xs text-stone-500 sm:flex-row sm:justify-between">
            ...
            <p>
              <Link href="/grants" className="hover:text-stone-700">Browse grants</Link> · <Link href="/coverage" className="hover:text-stone-700">Coverage</Link> · <Link href="/pricing" className="hover:text-stone-700">Alerts</Link>
            </p>
          </div>
        </footer>
      </body>
